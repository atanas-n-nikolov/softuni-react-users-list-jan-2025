    ...
    return (
        <tr>
            ...
            <td className="actions">
                <button onClick={() => onEdit(_id)} className="btn edit-btn" title="Edit">
                ...
                <button onClick={() => deleteUser(_id)} className="btn delete-btn" title="Delete">
                ...
                <button onClick={() => getUser(_id)} className="btn info-btn" title="Info">
