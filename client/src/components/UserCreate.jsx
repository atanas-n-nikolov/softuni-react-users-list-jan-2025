      ...
      <div className="modal">
        <div className="user-container">
          ...
          <form>
            ...
            <div id="form-actions">
              {userId ? <button onClick={onEdit} id="action-save" className="btn" type="submit">Edit</button> :  <button onClick={onSave} id="action-save" className="btn" type="submit">Save</button>}
